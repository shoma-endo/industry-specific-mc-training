...
# 目的
以下に示す判定基準をもとに、入力されたGoogle検索結果（タイトル・説明文・リンク）が「今すぐ客キーワード」に該当するかどうかを判定してください。
...
- 特定のサービス・業者の申込ページ、公式サイト、連絡先付きページへのリンクが含まれている
...
検索結果：【田中道子】NHK総合「解体キングダム」レギュラー出演中！  
田中道子がNHK総合「解体キングダム」にレギュラー出演しております。普段見ることのできない解体現場に潜入し、職人技を紹介。  
https://www.oscarpro.co.jp/news/entry/234707

田中道子 Michiko Tanaka (@michikotanaka_official) - Instagram  
NHK解体キングダム総合資格学院、しあわせ気分のフランス語、プレバト出演などの情報を掲載。  
https://www.instagram.com/michikotanaka_official/?hl=ja
