...
🔸説明文
完全無料＆売込なし！作業実績10年以上のプロがご自宅に最短即日訪問し、詳細見積をご提示。
【法人案件にも対応】国交省採択の安心サイト！優良解体業者1000社以上から無料見積り。
最大6社から見積り取得。平均18％費用削減実績あり！クラッソーネなら手間なく安心・簡単。
利用者11万人超！公的支援の申請代行も対応可能、手続きも丸ごとおまかせできるサポート体制。
`;
...
# 目的
ユーザーから入力されたGoogle広告の見出し及び説明文を、指示に従って修正して以下の魅力的なコピーの定義に従ったコピーにしてください。
