...
export const GOOGLE_SEARCH_TITLE_CATEGORIZATION_PROMPT = `
# 役割
Google広告リサーチのプロフェッショナル

# 目的
入力されたタイトルから以下の判断基準を元に「今すぐ客キーワード」と思われるワードがあれば'true'、そうでない場合は'false'を出力してください。
...
## 入力形式（改行区切り）
家の解体業者の相場はいくら？ | 【2025年4月】解体費用の最...
解体から廃材処分まで | 工場 解体工事
中国全域対応／アスベスト調査 | 石綿／各種書類の作成や届出...
// …他タイトル
