...
![LIFF-Template アーキテクチャ](./images/architecture_layers.svg)

*図: LIFF-Templateの階層型アーキテクチャ*
...
![LINE認証フロー](./images/auth_flow.svg)

*図: LINEアカウントを使用した認証フロー*
...
![サブスクリプション管理フロー](./images/subscription_flow.svg)

*図: Stripeを使用したサブスクリプション管理フロー*
